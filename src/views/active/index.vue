  ...
  <div class="home-box">
    ...
    <el-card>
      <el-form   :inline="true" >
        <el-form-item label="活动名称">
          <el-input v-model="name" placeholder="活动名称" clearable></el-input>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="tempname" label="引用模版" width="180">
        </el-table-column>
    ...
    <el-dialog
      ...
      <span class="dialog-footer">
        <el-button type="primary" @click="saveActive">保存</el-button>
      </span>
      </template>
    </el-dialog>
  </div>
